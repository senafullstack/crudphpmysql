    ...
    <body>
        <section>
            ...
            <br><br>
                    ...
                    <div class="container">
                        <form method="POST" action="agenda.php?acao=atualizar" enctype="multipart/form-data">
                             <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nome</label>
                                <input type="text" name="nome" value="<?php echo $dados->nome ?>" class="form-control"  aria-describedby="emailHelp">
                                    <input type="hidden" name="id_agenda" value="<?php echo $dados->id_agenda ?>" />
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Email </label>
                                <input type="email" value="<?php echo $dados->email ?>" name="email" class="form-control"  aria-describedby="emailHelp">
